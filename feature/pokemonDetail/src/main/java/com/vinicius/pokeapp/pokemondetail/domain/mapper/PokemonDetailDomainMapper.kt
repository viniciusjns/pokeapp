...
class PokemonDetailDomainMapper @Inject constructor(
    
): Mapper<PokemonDetailDataModel, PokemonDetailDomainModel> {
    override fun mapFrom(from: PokemonDetailDataModel): PokemonDetailDomainModel {
